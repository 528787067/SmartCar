...
/**
 * 寄存器修改说明：
 *		0X12				Bit[4] —— 0为元素分辨率（640*480），1为原始分辨率一半（320*240）	Bit[0] —— 1为彩色，0为黑白
 *		0X17 - 0X18			列数开窗大小（默认 0X00 - 0XA0）
 *		0X19 - 0X1A			行数开窗大小（默认 0X00 - 0X78）
 *		0X69				Bit[6] —— 0为彩色输出，1为黑白输出
 *		0X56				对比度调整阈值，默认 0X40
 **/

uint8_t  LandzoRAM[] = {					// 数字摄像头寄存器修改
...
/*
uint8_t  LandzoRAM[] = {					// 模拟摄像头寄存器修改
   0x0c,0x00,	0X12,0X10,	0X13,0X17,	0X15,0X02,	0X16,0X03,	0X03,0X00,	0X17,0X00,	0X18,0Xa0,
   0X19,0X00,	0X1a,0X78,	0X1b,0X2a,	0X1f,0X20,	0X20,0X02,	0X09,0X03,	0X21,0X00,	0X22,0X20,
   0X23,0X33,	0X24,0X8a,	0X25,0X7a,	0X2A,0X00,	0X2B,0X00,	0X2c,0X00,	0X2d,0X4f,	0X2e,0X96,
   0X2f,0X00,	0X3a,0X00,	0X3b,0X60,	0X3e,0X34,	0X3f,0Xb0,	0X40,0X4c,	0X41,0X3b,	0X42,0X30,
   0X43,0X25,	0X44,0X1d,	0X45,0X15,	0X46,0X10,	0X47,0X0f,	0X48,0X0d,	0X49,0X0b,	0X4b,0X09,
   0X4c,0X09,	0X4e,0X08,	0X4f,0X06,	0X50,0X05,	0X51,0X2f,	0X52,0X90,	0X53,0X01,	0X54,0X87,
   0X56,0X60,	0X57,0X32,	0X58,0X8b,	0X59,0X06,	0X5a,0X9b,	0X5b,0X35,	0X64,0X02,	0X67,0X80,
   0X68,0X80,	0X69,0XA0,	0X6a,0X89,	0X70,0Xae,	0X71,0Xa6,	0X72,0X4f,	0X73,0X5f,	0X74,0X27,
   0X80,0X5F,	0X81,0X08,	0X82,0X16,	0X83,0X24,	0X84,0X24,	0X85,0X2a,	0X86,0X4f,	0X89,0Xb2,
   0X8a,0Xaa,	0X8b,0X02,	0X8e,0X02,	0X8f,0X70,	0X95,0X14,	0X9d,0X36,	0X9e,0X04,	0Xa1,0X27,
   0Xa2,0X12,	0Xa3,0X2d,	0Xa4,0X08,	0Xa5,0X2e,	0Xa6,0X04,	0Xa7,0X80,	0Xa8,0X80,	0Xa9,0X21,
   0Xaa,0X21,	0Xab,0X21,	0Xac,0X0a,	0Xad,0Xf0,	0Xae,0Xff,	0Xb1,0Xb0,	0Xb2,0Xb0,	0Xb6,0X80,
   0Xb7,0X80,	0Xb8,0X80,	0Xb9,0X00,	0Xe7,0X7c,	0Xf0,0X01,	0Xf1,0X01,	0Xf1,0X01,	0Xf1,0X01,
};
*/
...
void IICWriteGpio_inint(void)
{
    ...
    gpio_init(PORTE, 12, GPO, HIGH);
	*/
	gpio_init(PTA25, GPO, HIGH);
	//gpio_init(PTE11, GPO, HIGH);
	gpio_init(PTA26, GPO, HIGH);
}
